...
if (isset($_POST['key'])) {
    ...
    $(document).ready(function() {
        $('#checkout').click(function(event) {
            ...
            if (!loggedIn) {
                alertify.alert('Checkout', 'Cannot checkout your product. Please log in first.',
                    function() {
                        // alertify.warning('Please login before proceeding to checkout.');
            ...
            // Perform the checkout process if the user is logged in
            // ...
        });
    });
    </script>
